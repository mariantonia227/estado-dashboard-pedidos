...
$resultPendientes = $enlace->query("SELECT COUNT(*) as total FROM pedidos WHERE id_negocios = '$id_negocio' AND estado = 'pendiente'");
...
$resultVentas = $enlace->query("SELECT SUM(total) as total FROM pedidos WHERE id_negocios = '$id_negocio' AND estado = 'completado'");
...
<div class="topbar">
    <div class="user-menu">
        <div class="user-trigger" onclick="toggleMenu()">
            <img src="assets/perfil-default.png" class="perfil-img" alt="Foto perfil">
